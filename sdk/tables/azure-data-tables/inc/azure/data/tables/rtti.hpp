 ...
 *
 * @details When RTTI is enabled, defines a macro `AZURE_DATA_TABLES_RTTI`.
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_DATA_TABLES_RTTI@*/)
#define AZURE_DATA_TABLES_RTTI
#endif
