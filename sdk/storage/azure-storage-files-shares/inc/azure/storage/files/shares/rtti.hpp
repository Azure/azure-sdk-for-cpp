 ...
 * `AZURE_STORAGE_FILES_SHARES_RTTI`. When the macro is not defined, RTTI is disabled.
 *
...
/**
 * @def AZURE_STORAGE_FILES_SHARES_RTTI
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_STORAGE_FILES_SHARES_RTTI@*/)
#define AZURE_STORAGE_FILES_SHARES_RTTI
#endif
