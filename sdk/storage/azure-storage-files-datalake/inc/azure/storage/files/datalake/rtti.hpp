 ...
 * `AZURE_STORAGE_FILES_DATALAKE_RTTI`. When the macro is not defined, RTTI is disabled.
 *
...
/**
 * @def AZURE_STORAGE_FILES_DATALAKE_RTTI
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_STORAGE_FILES_DATALAKE_RTTI@*/)
#define AZURE_STORAGE_FILES_DATALAKE_RTTI
#endif
