 ...
 * `AZ_STORAGE_FILES_DATALAKE_WITH_RTTI`. When the macro is not defined, RTTI is disabled.
 *
...
#if defined(AZ_BUILD_RTTI) || (0 /*@AZ_STORAGE_FILES_DATALAKE_WITH_RTTI@*/)
#define AZ_STORAGE_FILES_DATALAKE_WITH_RTTI
#endif
