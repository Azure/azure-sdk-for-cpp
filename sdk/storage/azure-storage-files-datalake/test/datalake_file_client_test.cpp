...
namespace Azure { namespace Storage { namespace Test {
  ...
  TEST_F(DataLakeFileClientTest, FileDataActions)
  {
    ...
    auto bufferStream = std::make_unique<Azure::IO::MemoryBodyStream>(
        Azure::IO::MemoryBodyStream(buffer));
    auto properties1 = m_fileClient->GetProperties();
  ...
  TEST_F(DataLakeFileClientTest, ConstructorsWorks)
  {
...

    {
      ...
      auto memoryStream
          = Azure::IO::MemoryBodyStream(blobContent.data(), blobContent.size());
