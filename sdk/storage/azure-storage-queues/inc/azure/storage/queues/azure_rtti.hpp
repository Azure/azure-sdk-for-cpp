 ...
 *
 * @details When RTTI is enabled, defines a macro `AZ_STORAGE_QUEUES_WITH_RTTI`.
...
#if defined(AZ_BUILD_RTTI) || (0 /*@AZ_STORAGE_QUEUES_WITH_RTTI@*/)
#define AZ_STORAGE_QUEUES_WITH_RTTI
#endif
