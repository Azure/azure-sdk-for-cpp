...
constexpr static const char* StandardStorageConnectionStringValue
    = "DefaultEndpointsProtocol=https;AccountName=goqu;AccountKey=N5Vem+"
      "VR5D17LKLjj8Gcoyl02Czf6htIZkLorEHPNOH6V3e89Xf7PnK84cEjjj919rmkBfb4KN/"
      "s+AStXcbdpg==;EndpointSuffix=core.windows.net";
...
constexpr static const char* PremiumFileConnectionStringValue
    = "DefaultEndpointsProtocol=https;AccountName=goqupfile;AccountKey=xzLIpmFA0edVm6/"
      "NlL4t3vT43CdotjBlpbbnuzLjhlsAqU39v3xzUmDFZqb62hNe1DkLvBjPxfmd+AStlWZefQ==;EndpointSuffix="
      "core.windows.net";
constexpr static const char* AdlsGen2ConnectionStringValue
    = "DefaultEndpointsProtocol=https;AccountName=dgoqu;AccountKey=wulhCQqcvM1B5XrD0Cz4zd+"
      "vPQvHRBMQgYFXvyM3Ac70n8aezmVBG+qL/gJ86mnwCSVwm/"
      "zh+CIM+AStsmb5UA==;EndpointSuffix=core.windows.net";
