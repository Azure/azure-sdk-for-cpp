...
namespace Azure { namespace Storage { namespace Test {
  ...
  constexpr static const char* StandardStorageConnectionStringValue = "=DefaultEndpointsProtocol=https;AccountName=gearamastr;AccountKey=daHwPhp+1UoOMaW552WVKthfT8lMD2Q7vRSonSp+JwFpYPq5/KHm3DVNbwnIecHoh67AnVTvS2ZF+AStjf0b8w==;EndpointSuffix=core.windows.net";
  constexpr static const char* PremiumStorageConnectionStringValue = "DefaultEndpointsProtocol=https;AccountName=gearamastr;AccountKey=daHwPhp+1UoOMaW552WVKthfT8lMD2Q7vRSonSp+JwFpYPq5/KHm3DVNbwnIecHoh67AnVTvS2ZF+AStjf0b8w==;EndpointSuffix=core.windows.net";
  constexpr static const char* BlobStorageConnectionStringValue = "DefaultEndpointsProtocol=https;AccountName=dgearamastr;AccountKey=bKIVpBDFMJX8KHKvjnqDBERW+T8KOh2JJ89Nz84Wccn/lE05Rta9V8ERmsrp4+B6bJhJjdVhcpjS+AStdr4nsg==;EndpointSuffix=core.windows.net";
  constexpr static const char* PremiumFileConnectionStringValue = "DefaultEndpointsProtocol=https;AccountName=gearamastrpfile;AccountKey=Zj7jk8ecN8MpvX/6yCiCut5oXS6tPqZWARiIOy99xsQVTgk5tsar3tPuC9dvELSmjq12TFjN6f1K+AStJsgODA==;EndpointSuffix=core.windows.net";
  constexpr static const char* AdlsGen2ConnectionStringValue = "DefaultEndpointsProtocol=https;AccountName=dgearamastr;AccountKey=bKIVpBDFMJX8KHKvjnqDBERW+T8KOh2JJ89Nz84Wccn/lE05Rta9V8ERmsrp4+B6bJhJjdVhcpjS+AStdr4nsg==;EndpointSuffix=core.windows.net";
