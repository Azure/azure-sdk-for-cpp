 ...
 *
 * @details Checks whenever RTTI is enabled and exports the symbol `AZ_STORAGE_COMMON_WITH_RTTI`. When
...
/**
 * @def AZ_STORAGE_COMMON_WITH_RTTI
 ...
 * header requires to resolve `AZ_STORAGE_COMMON_WITH_RTTI` which will become ` + 1 ` when the SDK was built
 * with RTTI and `false` otherwise.
 */

#if AZ_BUILD_RTTI || (0 /*@AZ_STORAGE_COMMON_WITH_RTTI@*/)
#define AZ_STORAGE_COMMON_WITH_RTTI 1
#endif
