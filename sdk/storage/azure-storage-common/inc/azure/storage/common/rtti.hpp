 ...
 *
 * @details When RTTI is enabled, defines a macro `AZURE_STORAGE_COMMON_RTTI`.
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_STORAGE_COMMON_RTTI@*/)
#define AZURE_STORAGE_COMMON_RTTI
#endif
