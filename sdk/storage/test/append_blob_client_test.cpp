...
namespace Azure { namespace Storage { namespace Test {
  ...
  void AppendBlobClientTest::SetUpTestSuite()
  {
    ...
    m_appendBlobClient->AppendBlock(m_blobContent);
  ...
  TEST_F(AppendBlobClientTest, CreateAppendDelete)
  {
    ...
    appendBlobClient.AppendBlock(m_blobContent);
    ...
    EXPECT_THROW(appendBlobClient.AppendBlock(m_blobContent, options), std::runtime_error);
    options.AppendPosition = properties.ContentLength;
    appendBlobClient.AppendBlock(m_blobContent, options);
