 ...
 *
 * @details When RTTI is enabled, defines a macro `AZ_STORAGE_DATAMOVEMENT_RTTI`.
...
/**
 * @def AZ_STORAGE_DATAMOVEMENT_RTTI
...
#if defined(AZ_RTTI) || (0 /*@AZ_STORAGE_DATAMOVEMENT_RTTI@*/)
#define AZ_STORAGE_DATAMOVEMENT_RTTI
#endif
