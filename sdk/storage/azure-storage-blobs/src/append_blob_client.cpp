...
namespace Azure { namespace Storage { namespace Blobs {
  ...
  AppendBlobClient AppendBlobClient::WithSnapshot(const std::string& snapshot) const
  {
    ...
    {
      newClient.m_blobUrl.AppendQueryParameter(Details::c_HttpQuerySnapshot, snapshot);
    }
    return newClient;
  }
  ...
  AppendBlobClient AppendBlobClient::WithVersionId(const std::string& versionId) const
  {
    ...
    {
      newClient.m_blobUrl.AppendQueryParameter(Details::c_HttpQueryVersionId, versionId);
    }
    return newClient;
  }
