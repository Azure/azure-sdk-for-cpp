...
#if defined(_MSC_VER)
#if defined(AZ_STORAGE_BLOBS_EXPORTS)
#define AZ_STORAGE_BLOBS_EXPORT __declspec(dllexport)
#else
#define AZ_STORAGE_BLOBS_EXPORT __declspec(dllimport)
#endif
#else
#define AZ_STORAGE_BLOBS_EXPORT
#endif
