...
#define AZURE_MESSAGING_EVENTHUBS_VERSION_PRERELEASE "beta0"

#define AZURE_MESSAGING_EVENTHUBS_VERSION_ITOA_HELPER(i) #i
#define AZURE_MESSAGING_EVENTHUBS_VERSION_ITOA(i) \
  AZURE_MESSAGING_EVENTHUBS_VERSION_ITOA_HELPER(i)
