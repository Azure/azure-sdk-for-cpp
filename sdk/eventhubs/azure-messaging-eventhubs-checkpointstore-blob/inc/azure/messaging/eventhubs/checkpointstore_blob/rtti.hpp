 ...
 * `AZURE_MESSAGING_EVENTHUBS_RTTI`. When the macro is not defined, RTTI is disabled.
 *
...
/**
 * @def AZURE_MESSAGING_EVENTHUBS_CHECKPOINTSTORE_BLOB_RTTI
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_MESSAGING_EVENTHUBS_CHECKPOINTSTORE_BLOB_RTTI@*/)
#define AZURE_MESSAGING_EVENTHUBS_CHECKPOINTSTORE_BLOB_RTTI
#endif
