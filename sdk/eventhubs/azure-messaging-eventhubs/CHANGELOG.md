...
- The uAMQP backend now retries a CBS authentication failure or exact unauthorized send or receive error once on a fresh connection, subject to `RetryOptions`, while preserving the final error.
