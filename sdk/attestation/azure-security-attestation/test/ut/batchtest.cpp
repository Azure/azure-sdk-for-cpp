...
namespace Azure { namespace Security { namespace Attestation { namespace Test {
  ...
  class BatchPolicyTests : public Azure::Core::Test::TestBase,
                           public testing::WithParamInterface<BatchTestParam> {
  private:
  protected:
  ...
  public:
    static std::vector<BatchTestParam> GetTestInputs()
    {
      std::vector<BatchTestParam> returnCases;
      ...
      for (auto const& value : typeNameList)
      {
        ...
        {
          returnCases.emplace_back(BatchTestParam{value, type});
        }
      }
      return returnCases;
    }
  ...
  TEST_P(BatchPolicyTests, BatchPolicyOperations)
  {
  ...
  namespace {
    std::string GetTestName(testing::TestParamInfo<BatchPolicyTests::ParamType> const& testInfo)
    {
      std::string testName;
  ...
  INSTANTIATE_TEST_SUITE_P(
      BatchPolicy,
      BatchPolicyTests,
      testing::ValuesIn(BatchPolicyTests::GetTestInputs()),
      GetTestName);
