 ...
 *
 * @details When RTTI is enabled, defines a macro `AZURE_ATTESTATION_RTTI`. When
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_ATTESTATION_RTTI@*/)
#define AZURE_ATTESTATION_RTTI
#endif
