 ...
 *
 * @details When RTTI is enabled, defines a macro `AZURE_TEMPLATE_RTTI`. When
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_TEMPLATE_RTTI@*/)
#define AZURE_TEMPLATE_RTTI
#endif
