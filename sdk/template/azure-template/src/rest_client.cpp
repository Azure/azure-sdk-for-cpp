...
std::string ListBlobContainersIncludeFlagsToString(
  ...
  const Azure::Storage::Blobs::Models::ListBlobContainersIncludeFlags
      valueList[] = {
          Azure::Storage::Blobs::Models::ListBlobContainersIncludeFlags::
              Metadata,
          Azure::Storage::Blobs::Models::ListBlobContainersIncludeFlags::
              Deleted,
      };
...
const BlobImmutabilityPolicyMode
...
const ScheduleBlobExpiryOriginType
    ScheduleBlobExpiryOriginType::NeverExpire("NeverExpire");
const ScheduleBlobExpiryOriginType
    ScheduleBlobExpiryOriginType::RelativeToCreation("RelativeToCreation");
const ScheduleBlobExpiryOriginType
    ScheduleBlobExpiryOriginType::RelativeToNow("RelativeToNow");
const ScheduleBlobExpiryOriginType
    ScheduleBlobExpiryOriginType::Absolute("Absolute");
...
Response<Models::SetServicePropertiesResult> ServiceClient::SetProperties(
    ...
    const SetServicePropertiesOptions &options, const Core::Context &context) {
  std::string xmlBody;
  {
    ...
    writer.Write(
        _internal::XmlNode{_internal::XmlNodeType::StartTag, "Logging"});
    writer.Write(
        _internal::XmlNode{_internal::XmlNodeType::StartTag, "Version",
                           options.BlobServiceProperties.Logging.Version});
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Delete",
        options.BlobServiceProperties.Logging.Delete ? "true" : "false"});
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Read",
        options.BlobServiceProperties.Logging.Read ? "true" : "false"});
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Write",
        options.BlobServiceProperties.Logging.Write ? "true" : "false"});
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
                                    "RetentionPolicy"});
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Enabled",
        options.BlobServiceProperties.Logging.RetentionPolicy.IsEnabled
            ? "true"
            : "false"});
    if (options.BlobServiceProperties.Logging.RetentionPolicy.Days.HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "Days",
          std::to_string(options.BlobServiceProperties.Logging.RetentionPolicy
                             .Days.Value())});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(
        _internal::XmlNode{_internal::XmlNodeType::StartTag, "HourMetrics"});
    writer.Write(
        _internal::XmlNode{_internal::XmlNodeType::StartTag, "Version",
                           options.BlobServiceProperties.HourMetrics.Version});
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Enabled",
        options.BlobServiceProperties.HourMetrics.IsEnabled ? "true"
                                                            : "false"});
    if (options.BlobServiceProperties.HourMetrics.IncludeApis.HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "IncludeAPIs",
          options.BlobServiceProperties.HourMetrics.IncludeApis.Value()
              ? "true"
              : "false"});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
    ...
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Enabled",
        options.BlobServiceProperties.HourMetrics.RetentionPolicy.IsEnabled
            ? "true"
            : "false"});
    if (options.BlobServiceProperties.HourMetrics.RetentionPolicy.Days
            .HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "Days",
          std::to_string(options.BlobServiceProperties.HourMetrics
                             .RetentionPolicy.Days.Value())});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(
        _internal::XmlNode{_internal::XmlNodeType::StartTag, "MinuteMetrics"});
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Version",
        options.BlobServiceProperties.MinuteMetrics.Version});
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Enabled",
        options.BlobServiceProperties.MinuteMetrics.IsEnabled ? "true"
                                                              : "false"});
    if (options.BlobServiceProperties.MinuteMetrics.IncludeApis.HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "IncludeAPIs",
          options.BlobServiceProperties.MinuteMetrics.IncludeApis.Value()
              ? "true"
              : "false"});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
    ...
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Enabled",
        options.BlobServiceProperties.MinuteMetrics.RetentionPolicy.IsEnabled
            ? "true"
            : "false"});
    if (options.BlobServiceProperties.MinuteMetrics.RetentionPolicy.Days
            .HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "Days",
          std::to_string(options.BlobServiceProperties.MinuteMetrics
                             .RetentionPolicy.Days.Value())});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    ...
    for (const auto &i1 : options.BlobServiceProperties.Cors) {
      writer.Write(
          _internal::XmlNode{_internal::XmlNodeType::StartTag, "CorsRule"});
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
                                      "AllowedOrigins", i1.AllowedOrigins});
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
                                      "AllowedMethods", i1.AllowedMethods});
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
                                      "AllowedHeaders", i1.AllowedHeaders});
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
                                      "ExposedHeaders", i1.ExposedHeaders});
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
                                      "MaxAgeInSeconds",
    ...
    if (options.BlobServiceProperties.DefaultServiceVersion.HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "DefaultServiceVersion",
    ...
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Enabled",
        options.BlobServiceProperties.DeleteRetentionPolicy.IsEnabled
            ? "true"
            : "false"});
    if (options.BlobServiceProperties.DeleteRetentionPolicy.Days.HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "Days",
          std::to_string(options.BlobServiceProperties.DeleteRetentionPolicy
                             .Days.Value())});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(
        _internal::XmlNode{_internal::XmlNodeType::StartTag, "StaticWebsite"});
    writer.Write(_internal::XmlNode{
        _internal::XmlNodeType::StartTag, "Enabled",
        options.BlobServiceProperties.StaticWebsite.IsEnabled ? "true"
                                                              : "false"});
    if (options.BlobServiceProperties.StaticWebsite.IndexDocument.HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "IndexDocument",
          options.BlobServiceProperties.StaticWebsite.IndexDocument.Value()});
    }
    if (options.BlobServiceProperties.StaticWebsite.ErrorDocument404Path
            .HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "ErrorDocument404Path",
          options.BlobServiceProperties.StaticWebsite.ErrorDocument404Path
              .Value()});
    }
    if (options.BlobServiceProperties.StaticWebsite.DefaultIndexDocumentPath
            .HasValue()) {
      writer.Write(_internal::XmlNode{
          _internal::XmlNodeType::StartTag, "DefaultIndexDocumentPath",
          options.BlobServiceProperties.StaticWebsite.DefaultIndexDocumentPath
              .Value()});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
  ...
  return Response<Models::SetServicePropertiesResult>(std::move(response),
                                                      std::move(pRawResponse));
}
Response<Models::BlobServiceProperties> ServiceClient::GetProperties(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const GetServicePropertiesOptions &options, const Core::Context &context) {
  ...
  Models::BlobServiceProperties response;
  {
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        xmlPath.push_back(ite == XmlTagEnumMap.end() ? XmlTagEnum::kUnknown
                                                     : ite->second);

      } else if (node.Type == _internal::XmlNodeType::Text) {
        if (xmlPath.size() == 3 &&
            xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
            xmlPath[1] == XmlTagEnum::kLogging &&
            xmlPath[2] == XmlTagEnum::kVersion) {
          response.Logging.Version = node.Value;
        } else if (xmlPath.size() == 3 &&
                   xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
                   xmlPath[1] == XmlTagEnum::kLogging &&
                   xmlPath[2] == XmlTagEnum::kDelete) {
          response.Logging.Delete = node.Value == std::string("true");
        } else if (xmlPath.size() == 3 &&
                   xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
                   xmlPath[1] == XmlTagEnum::kLogging &&
                   xmlPath[2] == XmlTagEnum::kRead) {
          response.Logging.Read = node.Value == std::string("true");
        } else if (xmlPath.size() == 3 &&
                   xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
                   xmlPath[1] == XmlTagEnum::kLogging &&
                   xmlPath[2] == XmlTagEnum::kWrite) {
          response.Logging.Write = node.Value == std::string("true");
        } else if (xmlPath.size() == 4 &&
                   xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
                   xmlPath[1] == XmlTagEnum::kLogging &&
                   xmlPath[2] == XmlTagEnum::kRetentionPolicy &&
                   xmlPath[3] == XmlTagEnum::kEnabled) {
          response.Logging.RetentionPolicy.IsEnabled =
          ...
          response.HourMetrics.IncludeApis = node.Value == std::string("true");
                   ...
                   xmlPath[2] == XmlTagEnum::kRetentionPolicy &&
                   xmlPath[3] == XmlTagEnum::kEnabled) {
          response.HourMetrics.RetentionPolicy.IsEnabled =
              node.Value == std::string("true");
        } else if (xmlPath.size() == 4 &&
                   xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
                   xmlPath[1] == XmlTagEnum::kHourMetrics &&
          ...
          response.MinuteMetrics.IncludeApis =
              node.Value == std::string("true");
                   ...
                   xmlPath[2] == XmlTagEnum::kRetentionPolicy &&
                   xmlPath[3] == XmlTagEnum::kEnabled) {
          response.MinuteMetrics.RetentionPolicy.IsEnabled =
              node.Value == std::string("true");
        } else if (xmlPath.size() == 4 &&
                   xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
                   xmlPath[1] == XmlTagEnum::kMinuteMetrics &&
          ...
          response.MinuteMetrics.RetentionPolicy.Days = std::stoi(node.Value);
                   ...
                   xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
                   xmlPath[1] == XmlTagEnum::kCors &&
                   xmlPath[2] == XmlTagEnum::kCorsRule &&
          ...
          response.DefaultServiceVersion = node.Value;
                   ...
                   xmlPath[2] == XmlTagEnum::kEnabled) {
          response.DeleteRetentionPolicy.IsEnabled =
              node.Value == std::string("true");
        } else if (xmlPath.size() == 3 &&
                   xmlPath[0] == XmlTagEnum::kStorageServiceProperties &&
                   xmlPath[1] == XmlTagEnum::kDeleteRetentionPolicy &&
  ...
  return Response<Models::BlobServiceProperties>(std::move(response),
                                                 std::move(pRawResponse));
}
Response<Models::ServiceStatistics> ServiceClient::GetStatistics(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const GetServiceStatisticsOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Get, url);
  request.GetUrl().AppendQueryParameter("restype", "service");
  ...
  Models::ServiceStatistics response;
  {
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 3 &&
            xmlPath[0] == XmlTagEnum::kStorageServiceStats &&
            xmlPath[1] == XmlTagEnum::kGeoReplication &&
            xmlPath[2] == XmlTagEnum::kStatus) {
          response.GeoReplication.Status =
              Models::GeoReplicationStatus(node.Value);
        } else if (xmlPath.size() == 3 &&
                   xmlPath[0] == XmlTagEnum::kStorageServiceStats &&
                   xmlPath[1] == XmlTagEnum::kGeoReplication &&
  ...
  return Response<Models::ServiceStatistics>(std::move(response),
                                             std::move(pRawResponse));
}
Response<Models::_detail::ListBlobContainersResult>
  ...
  Models::_detail::ListBlobContainersResult response;
  {
    ...
    const std::unordered_map<std::string, XmlTagEnum> XmlTagEnumMap{
        ...
        {"DenyEncryptionScopeOverride",
         XmlTagEnum::kDenyEncryptionScopeOverride},
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        xmlPath.push_back(ite == XmlTagEnumMap.end() ? XmlTagEnum::kUnknown
                                                     : ite->second);
        if (xmlPath.size() == 5 &&
            xmlPath[0] == XmlTagEnum::kEnumerationResults &&
            xmlPath[1] == XmlTagEnum::kContainers &&
            xmlPath[2] == XmlTagEnum::kContainer &&
        ...
        if (xmlPath.size() == 2 &&
        ...
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kContainers &&
                   xmlPath[2] == XmlTagEnum::kContainer &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kLastModified) {
          ...
          vectorElement1.Details.ETag = ETag(node.Value);
                   ...
                   xmlPath[2] == XmlTagEnum::kContainer &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kLeaseStatus) {
          vectorElement1.Details.LeaseStatus = Models::LeaseStatus(node.Value);
                   ...
                   xmlPath[2] == XmlTagEnum::kContainer &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kLeaseState) {
          ...
          vectorElement1.Details.LeaseDuration =
              Models::LeaseDurationType(node.Value);
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kContainers &&
                   xmlPath[2] == XmlTagEnum::kContainer &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kPublicAccess) {
          vectorElement1.Details.AccessType =
              Models::PublicAccessType(node.Value);
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kContainers &&
                   xmlPath[2] == XmlTagEnum::kContainer &&
          ...
          vectorElement1.Details.HasImmutabilityPolicy =
              node.Value == std::string("true");
                   ...
                   xmlPath[2] == XmlTagEnum::kContainer &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kHasLegalHold) {
          vectorElement1.Details.HasLegalHold =
              node.Value == std::string("true");
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kContainers &&
          ...
          vectorElement1.Details.PreventEncryptionScopeOverride =
              node.Value == std::string("true");
                   ...
                   xmlPath[2] == XmlTagEnum::kContainer &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kDeletedTime) {
        ...
        if (xmlPath.size() == 5 &&
            ...
            xmlPath[2] == XmlTagEnum::kContainer &&
            xmlPath[3] == XmlTagEnum::kMetadata) {
          vectorElement1.Details.Metadata[std::move(mapKey2)] =
              std::move(mapValue3);
        } else if (xmlPath.size() == 3 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kContainers &&
...
Response<Models::UserDelegationKey> ServiceClient::GetUserDelegationKey(
  ...
  Core::IO::MemoryBodyStream requestBody(
      reinterpret_cast<const uint8_t *>(xmlBody.data()), xmlBody.length());
  auto request =
      Core::Http::Request(Core::Http::HttpMethod::Post, url, &requestBody);
  request.SetHeader("Content-Type", "application/xml; charset=UTF-8");
  request.SetHeader("Content-Length", std::to_string(requestBody.Length()));
  request.GetUrl().AppendQueryParameter("restype", "service");
  ...
  Models::UserDelegationKey response;
  {
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 2 &&
            xmlPath[0] == XmlTagEnum::kUserDelegationKey &&
  ...
  return Response<Models::UserDelegationKey>(std::move(response),
                                             std::move(pRawResponse));
}
Response<Models::AccountInfo> ServiceClient::GetAccountInfo(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const GetServiceAccountInfoOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Get, url);
  ...
  response.SkuName =
      Models::SkuName(pRawResponse->GetHeaders().at("x-ms-sku-name"));
  ...
  response.IsHierarchicalNamespaceEnabled =
      pRawResponse->GetHeaders().at("x-ms-is-hns-enabled") ==
      std::string("true");
  return Response<Models::AccountInfo>(std::move(response),
                                       std::move(pRawResponse));
}
Response<Models::_detail::FindBlobsByTagsResult>
ServiceClient::FindBlobsByTags(Core::Http::_internal::HttpPipeline &pipeline,
                               const Core::Url &url,
  ...
  Models::_detail::FindBlobsByTagsResult response;
  {
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 4 &&
            xmlPath[0] == XmlTagEnum::kEnumerationResults &&
            xmlPath[1] == XmlTagEnum::kBlobs &&
            xmlPath[2] == XmlTagEnum::kBlob &&
            xmlPath[3] == XmlTagEnum::kName) {
        ...
        } else if (xmlPath.size() == 7 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kTags &&
                   xmlPath[4] == XmlTagEnum::kTagSet &&
                   xmlPath[5] == XmlTagEnum::kTag &&
                   xmlPath[6] == XmlTagEnum::kKey) {
          mapKey2 = node.Value;
        } else if (xmlPath.size() == 7 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
...
Response<Models::CreateBlobContainerResult> BlobContainerClient::Create(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const CreateBlobContainerOptions &options, const Core::Context &context) {
  ...
  if (options.DefaultEncryptionScope.HasValue() &&
    ...
    request.SetHeader("x-ms-default-encryption-scope",
                      options.DefaultEncryptionScope.Value());
  }
  if (options.PreventEncryptionScopeOverride.HasValue()) {
    request.SetHeader("x-ms-deny-encryption-scope-override",
                      options.PreventEncryptionScopeOverride.Value() ? "true"
                                                                     : "false");
  }
  auto pRawResponse = pipeline.Send(request, context);
  auto httpStatusCode = pRawResponse->GetStatusCode();
  ...
  return Response<Models::CreateBlobContainerResult>(std::move(response),
                                                     std::move(pRawResponse));
}
Response<Models::BlobContainerProperties> BlobContainerClient::GetProperties(
  ...
  for (auto i = pRawResponse->GetHeaders().lower_bound("x-ms-meta-");
       i != pRawResponse->GetHeaders().end() &&
       i->first.substr(0, 10) == "x-ms-meta-";
       ++i) {
  ...
  if (pRawResponse->GetHeaders().count("x-ms-lease-duration") != 0) {
    response.LeaseDuration = Models::LeaseDurationType(
        pRawResponse->GetHeaders().at("x-ms-lease-duration"));
  }
  response.LeaseState =
  ...
  if (pRawResponse->GetHeaders().count("x-ms-blob-public-access") != 0) {
    response.AccessType = Models::PublicAccessType(
        pRawResponse->GetHeaders().at("x-ms-blob-public-access"));
  }
  response.HasImmutabilityPolicy =
      pRawResponse->GetHeaders().at("x-ms-has-immutability-policy") ==
      std::string("true");
  response.HasLegalHold = pRawResponse->GetHeaders().at(
                              "x-ms-has-legal-hold") == std::string("true");
  ...
  if (pRawResponse->GetHeaders().count("x-ms-deny-encryption-scope-override") !=
      0) {
...
Response<Models::DeleteBlobContainerResult> BlobContainerClient::Delete(
  ...
  if (options.IfModifiedSince.HasValue()) {
    request.SetHeader("If-Modified-Since",
                      options.IfModifiedSince.Value().ToString(
                          Azure::DateTime::DateFormat::Rfc1123));
  }
  ...
  return Response<Models::DeleteBlobContainerResult>(std::move(response),
                                                     std::move(pRawResponse));
}
Response<Models::SetBlobContainerMetadataResult>
BlobContainerClient::SetMetadata(Core::Http::_internal::HttpPipeline &pipeline,
                                 const Core::Url &url,
...
Response<Models::BlobContainerAccessPolicy>
BlobContainerClient::GetAccessPolicy(
  ...
  Models::BlobContainerAccessPolicy response;
  {
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 3 &&
            xmlPath[0] == XmlTagEnum::kSignedIdentifiers &&
            xmlPath[1] == XmlTagEnum::kSignedIdentifier &&
            xmlPath[2] == XmlTagEnum::kId) {
          vectorElement1.Id = node.Value;
        } else if (xmlPath.size() == 4 &&
                   xmlPath[0] == XmlTagEnum::kSignedIdentifiers &&
                   xmlPath[1] == XmlTagEnum::kSignedIdentifier &&
                   xmlPath[2] == XmlTagEnum::kAccessPolicy &&
  ...
  return Response<Models::BlobContainerAccessPolicy>(std::move(response),
                                                     std::move(pRawResponse));
}
Response<Models::SetBlobContainerAccessPolicyResult>
  ...
  std::string xmlBody;
  {
    ...
    for (const auto &i1 : options.ContainerAcl) {
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
                                      "SignedIdentifier"});
      writer.Write(
          _internal::XmlNode{_internal::XmlNodeType::StartTag, "Id", i1.Id});
      writer.Write(
          _internal::XmlNode{_internal::XmlNodeType::StartTag, "AccessPolicy"});
      if (i1.StartsOn.HasValue()) {
        writer.Write(_internal::XmlNode{
            _internal::XmlNodeType::StartTag, "Start",
      ...
      if (i1.ExpiresOn.HasValue()) {
        writer.Write(_internal::XmlNode{
            _internal::XmlNodeType::StartTag, "Expiry",
            i1.ExpiresOn.Value().ToString(
                Azure::DateTime::DateFormat::Rfc3339,
                Azure::DateTime::TimeFractionFormat::AllDigits)});
      }
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::StartTag,
                                      "Permission", i1.Permissions});
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
...
Response<Models::_detail::UndeleteBlobContainerResult>
BlobContainerClient::Undelete(Core::Http::_internal::HttpPipeline &pipeline,
                              const Core::Url &url,
  ...
  request.SetHeader("x-ms-version", "2020-08-04");
  if (options.DeletedContainerName.HasValue() &&
      !options.DeletedContainerName.Value().empty()) {
    request.SetHeader("x-ms-deleted-container-name",
                      options.DeletedContainerName.Value());
  }
  if (options.DeletedContainerVersion.HasValue() &&
      !options.DeletedContainerVersion.Value().empty()) {
    request.SetHeader("x-ms-deleted-container-version",
                      options.DeletedContainerVersion.Value());
  }
  auto pRawResponse = pipeline.Send(request, context);
  auto httpStatusCode = pRawResponse->GetStatusCode();
  if (httpStatusCode != Core::Http::HttpStatusCode::Created) {
...
Response<Models::_detail::RenameBlobContainerResult>
BlobContainerClient::Rename(Core::Http::_internal::HttpPipeline &pipeline,
                            const Core::Url &url,
  ...
  if (!options.SourceContainerName.empty()) {
    request.SetHeader("x-ms-source-container-name",
                      options.SourceContainerName);
  }
  if (options.SourceLeaseId.HasValue() &&
      !options.SourceLeaseId.Value().empty()) {
...
Response<Models::_detail::AcquireBlobContainerLeaseResult>
BlobContainerClient::AcquireLease(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
  ...
  if (options.Duration.HasValue()) {
    request.SetHeader("x-ms-lease-duration",
                      std::to_string(options.Duration.Value()));
  }
  if (options.ProposedLeaseId.HasValue() &&
      !options.ProposedLeaseId.Value().empty()) {
    request.SetHeader("x-ms-proposed-lease-id",
                      options.ProposedLeaseId.Value());
  }
  if (options.IfModifiedSince.HasValue()) {
    request.SetHeader("If-Modified-Since",
                      options.IfModifiedSince.Value().ToString(
...
Response<Models::_detail::ReleaseBlobContainerLeaseResult>
BlobContainerClient::ReleaseLease(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
...
Response<Models::_detail::RenewBlobContainerLeaseResult>
BlobContainerClient::RenewLease(Core::Http::_internal::HttpPipeline &pipeline,
                                const Core::Url &url,
...
Response<Models::_detail::BreakBlobContainerLeaseResult>
BlobContainerClient::BreakLease(Core::Http::_internal::HttpPipeline &pipeline,
                                const Core::Url &url,
  ...
  if (options.BreakPeriod.HasValue()) {
    request.SetHeader("x-ms-lease-break-period",
                      std::to_string(options.BreakPeriod.Value()));
  }
  if (options.IfModifiedSince.HasValue()) {
    request.SetHeader("If-Modified-Since",
                      options.IfModifiedSince.Value().ToString(
  ...
  response.LastModified =
      DateTime::Parse(pRawResponse->GetHeaders().at("Last-Modified"),
                      Azure::DateTime::DateFormat::Rfc1123);
  response.LeaseTime =
      std::stoi(pRawResponse->GetHeaders().at("x-ms-lease-time"));
  return Response<Models::_detail::BreakBlobContainerLeaseResult>(
      std::move(response), std::move(pRawResponse));
}
Response<Models::_detail::ChangeBlobContainerLeaseResult>
BlobContainerClient::ChangeLease(Core::Http::_internal::HttpPipeline &pipeline,
                                 const Core::Url &url,
...
Response<Models::_detail::ListBlobsResult>
BlobContainerClient::ListBlobs(Core::Http::_internal::HttpPipeline &pipeline,
                               const Core::Url &url,
  ...
  if (options.Include.HasValue() &&
    ...
    request.GetUrl().AppendQueryParameter(
        "include", _internal::UrlEncodeQueryParameter(
  ...
  Models::_detail::ListBlobsResult response;
  {
    ...
    const std::unordered_map<std::string, XmlTagEnum> XmlTagEnumMap{
        ...
        {"ImmutabilityPolicyUntilDate",
         XmlTagEnum::kImmutabilityPolicyUntilDate},
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 5 &&
          ...
          vectorElement1.Details.ImmutabilityPolicy =
              Models::BlobImmutabilityPolicy();
        }
      } else if (node.Type == _internal::XmlNodeType::Text) {
        if (xmlPath.size() == 2 &&
            xmlPath[0] == XmlTagEnum::kEnumerationResults &&
          ...
          vectorElement1.IsCurrentVersion = node.Value == std::string("true");
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kCreationTime) {
          ...
          vectorElement1.Details.CopyId = node.Value;
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kCopyStatus) {
          vectorElement1.Details.CopyStatus = Models::CopyStatus(node.Value);
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kCopySource) {
          vectorElement1.Details.CopySource = node.Value;
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kCopyProgress) {
          ...
          vectorElement1.Details.IsServerEncrypted =
              node.Value == std::string("true");
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
          ...
          vectorElement1.Details.IsIncrementalCopy =
              node.Value == std::string("true");
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
          ...
          vectorElement1.Details.IncrementalCopyDestinationSnapshot =
              node.Value;
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
          ...
          vectorElement1.Details.RemainingRetentionDays = std::stoi(node.Value);
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kAccessTier) {
          ...
          vectorElement1.Details.IsAccessTierInferred =
              node.Value == std::string("true");
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
          ...
          vectorElement1.Details.ArchiveStatus =
              Models::ArchiveStatus(node.Value);
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
                   xmlPath[2] == XmlTagEnum::kBlob &&
          ...
          vectorElement1.Details.EncryptionKeySha256 =
          ...
          vectorElement1.Details.AccessTierChangedOn =
              DateTime::Parse(node.Value, Azure::DateTime::DateFormat::Rfc1123);
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kExpiryTime) {
          ...
          vectorElement1.Details.RehydratePriority =
              Models::RehydratePriority(node.Value);
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
                   xmlPath[2] == XmlTagEnum::kBlob &&
          ...
          vectorElement1.Details.LastAccessedOn =
              DateTime::Parse(node.Value, Azure::DateTime::DateFormat::Rfc1123);
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kLegalHold) {
          vectorElement1.Details.HasLegalHold =
              node.Value == std::string("true");
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kContentType) {
          ...
          vectorElement1.Details.HttpHeaders.ContentLanguage = node.Value;
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kContentMD5) {
          ...
          vectorElement1.Details.HttpHeaders.ContentDisposition = node.Value;
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kCacheControl) {
          ...
          mapValue5 = node.Value;
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kOrMetadata) {
          vectorElement7.ReplicationStatus =
              Models::ObjectReplicationStatus(node.Value);
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
                   xmlPath[2] == XmlTagEnum::kBlob &&
          ...
          vectorElement1.BlobSize = std::stoll(node.Value);
                   ...
                   xmlPath[2] == XmlTagEnum::kBlob &&
                   xmlPath[3] == XmlTagEnum::kProperties &&
                   xmlPath[4] == XmlTagEnum::kBlobType) {
        ...
        if (xmlPath.size() == 5 &&
          ...
          vectorElement1.Details.Metadata[std::move(mapKey2)] =
              std::move(mapValue3);
                   ...
                   xmlPath[5] == XmlTagEnum::kTag &&
                   xmlPath[6] == XmlTagEnum::kValue) {
          vectorElement1.Details.Tags[std::move(mapKey4)] =
              std::move(mapValue5);
        } else if (xmlPath.size() == 5 &&
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
  ...
  return Response<Models::_detail::ListBlobsResult>(std::move(response),
                                                    std::move(pRawResponse));
}
Response<Models::_detail::ListBlobsByHierarchyResult>
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 2 &&
          ...
          vectorElement1.BlobType = Models::BlobType(node.Value);
                   ...
                   xmlPath[0] == XmlTagEnum::kEnumerationResults &&
                   xmlPath[1] == XmlTagEnum::kBlobs &&
                   xmlPath[2] == XmlTagEnum::kBlobPrefix &&
                   xmlPath[3] == XmlTagEnum::kName) {
...
Response<Models::DownloadBlobResult>
BlobClient::Download(Core::Http::_internal::HttpPipeline &pipeline,
                     const Core::Url &url, const DownloadBlobOptions &options,
                     const Core::Context &context) {
  ...
  if (options.Snapshot.HasValue() && !options.Snapshot.Value().empty()) {
    request.GetUrl().AppendQueryParameter(
        "snapshot",
        _internal::UrlEncodeQueryParameter(options.Snapshot.Value()));
  }
  if (options.VersionId.HasValue() && !options.VersionId.Value().empty()) {
    request.GetUrl().AppendQueryParameter(
        "versionid",
        _internal::UrlEncodeQueryParameter(options.VersionId.Value()));
  }
  ...
  if (options.RangeGetContentMD5.HasValue()) {
    request.SetHeader("x-ms-range-get-content-md5",
                      options.RangeGetContentMD5.Value() ? "true" : "false");
  }
  if (options.RangeGetContentCRC64.HasValue()) {
    request.SetHeader("x-ms-range-get-content-crc64",
                      options.RangeGetContentCRC64.Value() ? "true" : "false");
  }
  if (options.EncryptionKey.HasValue() &&
      !options.EncryptionKey.Value().empty()) {
  ...
  if (options.EncryptionAlgorithm.HasValue() &&
      !options.EncryptionAlgorithm.Value().empty()) {
    request.SetHeader("x-ms-encryption-algorithm",
                      options.EncryptionAlgorithm.Value());
  }
  if (options.IfModifiedSince.HasValue()) {
    request.SetHeader("If-Modified-Since",
                      options.IfModifiedSince.Value().ToString(
  ...
  if (pRawResponse->GetHeaders().count("Content-Type") != 0) {
    response.Details.HttpHeaders.ContentType =
        pRawResponse->GetHeaders().at("Content-Type");
  }
  ...
  if (pRawResponse->GetHeaders().count("Cache-Control") != 0) {
    response.Details.HttpHeaders.CacheControl =
  ...
  if (pRawResponse->GetHeaders().count("x-ms-copy-progress") != 0) {
    response.Details.CopyProgress =
        pRawResponse->GetHeaders().at("x-ms-copy-progress");
  }
  if (pRawResponse->GetHeaders().count("x-ms-copy-source") != 0) {
    response.Details.CopySource =
        pRawResponse->GetHeaders().at("x-ms-copy-source");
  }
  ...
  if (pRawResponse->GetHeaders().count("x-ms-lease-duration") != 0) {
    response.Details.LeaseDuration = Models::LeaseDurationType(
        pRawResponse->GetHeaders().at("x-ms-lease-duration"));
  }
  ...
  if (pRawResponse->GetHeaders().count("x-ms-version-id") != 0) {
    response.Details.VersionId =
        pRawResponse->GetHeaders().at("x-ms-version-id");
  }
  if (pRawResponse->GetHeaders().count("x-ms-is-current-version") != 0) {
    response.Details.IsCurrentVersion =
        pRawResponse->GetHeaders().at("x-ms-is-current-version") ==
        std::string("true");
  }
  if (pRawResponse->GetHeaders().count("x-ms-blob-committed-block-count") !=
      0) {
    response.Details.CommittedBlockCount = std::stoi(
        pRawResponse->GetHeaders().at("x-ms-blob-committed-block-count"));
  }
  response.Details.IsServerEncrypted =
      pRawResponse->GetHeaders().at("x-ms-server-encrypted") ==
      std::string("true");
  ...
  if (pRawResponse->GetHeaders().count("x-ms-encryption-scope") != 0) {
    response.Details.EncryptionScope =
        pRawResponse->GetHeaders().at("x-ms-encryption-scope");
  }
  if (pRawResponse->GetHeaders().count("x-ms-tag-count") != 0) {
    response.Details.TagCount =
        std::stoi(pRawResponse->GetHeaders().at("x-ms-tag-count"));
  }
  if (pRawResponse->GetHeaders().count("x-ms-blob-sealed") != 0) {
    response.Details.IsSealed = pRawResponse->GetHeaders().at(
                                    "x-ms-blob-sealed") == std::string("true");
  }
  if (pRawResponse->GetHeaders().count("x-ms-last-access-time") != 0) {
    response.Details.LastAccessedOn =
        DateTime::Parse(pRawResponse->GetHeaders().at("x-ms-last-access-time"),
                        Azure::DateTime::DateFormat::Rfc1123);
  }
  if (pRawResponse->GetHeaders().count("x-ms-immutability-policy-until-date") !=
      0) {
  ...
  if (pRawResponse->GetHeaders().count("x-ms-immutability-policy-mode") != 0) {
    ...
    response.Details.ImmutabilityPolicy.Value().PolicyMode =
  ...
  response.Details.CreatedOn =
      DateTime::Parse(pRawResponse->GetHeaders().at("x-ms-creation-time"),
                      Azure::DateTime::DateFormat::Rfc1123);
  if (httpStatusCode == Core::Http::HttpStatusCode::Ok) {
    if (pRawResponse->GetHeaders().count("Content-MD5") != 0) {
      response.Details.HttpHeaders.ContentHash.Value =
          Core::Convert::Base64Decode(
              pRawResponse->GetHeaders().at("Content-MD5"));
  ...
  if (pRawResponse->GetHeaders().count("x-ms-blob-content-md5") != 0) {
    response.Details.HttpHeaders.ContentHash.Value =
        Core::Convert::Base64Decode(
            pRawResponse->GetHeaders().at("x-ms-blob-content-md5"));
    response.Details.HttpHeaders.ContentHash.Algorithm = HashAlgorithm::Md5;
  }
  ...
  if (httpStatusCode == Core::Http::HttpStatusCode::PartialContent) {
    if (pRawResponse->GetHeaders().count("x-ms-content-crc64") != 0) {
      ...
      response.TransactionalContentHash.Value().Value =
          Core::Convert::Base64Decode(
              pRawResponse->GetHeaders().at("x-ms-content-crc64"));
      response.TransactionalContentHash.Value().Algorithm =
          HashAlgorithm::Crc64;
    }
  }
  return Response<Models::DownloadBlobResult>(std::move(response),
                                              std::move(pRawResponse));
}
Response<Models::BlobProperties> BlobClient::GetProperties(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const GetBlobPropertiesOptions &options, const Core::Context &context) {
  ...
  if (pRawResponse->GetHeaders().count("x-ms-incremental-copy") != 0) {
    response.IsIncrementalCopy =
        pRawResponse->GetHeaders().at("x-ms-incremental-copy") ==
        std::string("true");
  }
  ...
  response.BlobSize =
      std::stoll(pRawResponse->GetHeaders().at("Content-Length"));
  if (pRawResponse->GetHeaders().count("Content-Type") != 0) {
    response.HttpHeaders.ContentType =
        pRawResponse->GetHeaders().at("Content-Type");
  }
  response.ETag = ETag(pRawResponse->GetHeaders().at("ETag"));
  if (pRawResponse->GetHeaders().count("Content-MD5") != 0) {
    response.HttpHeaders.ContentHash.Value = Core::Convert::Base64Decode(
        pRawResponse->GetHeaders().at("Content-MD5"));
  ...
  if (pRawResponse->GetHeaders().count("x-ms-blob-committed-block-count") !=
      0) {
    response.CommittedBlockCount = std::stoi(
        pRawResponse->GetHeaders().at("x-ms-blob-committed-block-count"));
  }
  ...
  if (pRawResponse->GetHeaders().count("x-ms-access-tier-inferred") != 0) {
    response.IsAccessTierInferred =
        pRawResponse->GetHeaders().at("x-ms-access-tier-inferred") ==
        std::string("true");
  }
  if (pRawResponse->GetHeaders().count("x-ms-archive-status") != 0) {
    response.ArchiveStatus = Models::ArchiveStatus(
        pRawResponse->GetHeaders().at("x-ms-archive-status"));
  }
  ...
  if (pRawResponse->GetHeaders().count("x-ms-expiry-time") != 0) {
    response.ExpiresOn =
        DateTime::Parse(pRawResponse->GetHeaders().at("x-ms-expiry-time"),
                        Azure::DateTime::DateFormat::Rfc1123);
  }
  if (pRawResponse->GetHeaders().count("x-ms-blob-sealed") != 0) {
    response.IsSealed = pRawResponse->GetHeaders().at("x-ms-blob-sealed") ==
                        std::string("true");
  }
  if (pRawResponse->GetHeaders().count("x-ms-rehydrate-priority") != 0) {
    response.RehydratePriority = Models::RehydratePriority(
        pRawResponse->GetHeaders().at("x-ms-rehydrate-priority"));
  }
  if (pRawResponse->GetHeaders().count("x-ms-last-access-time") != 0) {
    response.LastAccessedOn =
        DateTime::Parse(pRawResponse->GetHeaders().at("x-ms-last-access-time"),
                        Azure::DateTime::DateFormat::Rfc1123);
  }
  if (pRawResponse->GetHeaders().count("x-ms-immutability-policy-until-date") !=
  ...
  if (pRawResponse->GetHeaders().count("x-ms-immutability-policy-mode") != 0) {
    ...
    response.ImmutabilityPolicy.Value().PolicyMode =
        Models::BlobImmutabilityPolicyMode(
            pRawResponse->GetHeaders().at("x-ms-immutability-policy-mode"));
  }
  if (pRawResponse->GetHeaders().count("x-ms-legal-hold") != 0) {
  ...
  return Response<Models::BlobProperties>(std::move(response),
                                          std::move(pRawResponse));
}
Response<Models::DeleteBlobResult>
BlobClient::Delete(Core::Http::_internal::HttpPipeline &pipeline,
                   const Core::Url &url, const DeleteBlobOptions &options,
                   const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Delete, url);
  if (options.Snapshot.HasValue() && !options.Snapshot.Value().empty()) {
    request.GetUrl().AppendQueryParameter(
  ...
  if (options.DeleteSnapshots.HasValue() &&
      !options.DeleteSnapshots.Value().ToString().empty()) {
    request.SetHeader("x-ms-delete-snapshots",
                      options.DeleteSnapshots.Value().ToString());
  }
  if (options.IfModifiedSince.HasValue()) {
    request.SetHeader("If-Modified-Since",
                      options.IfModifiedSince.Value().ToString(
  ...
  return Response<Models::DeleteBlobResult>(std::move(response),
                                            std::move(pRawResponse));
}
Response<Models::UndeleteBlobResult>
BlobClient::Undelete(Core::Http::_internal::HttpPipeline &pipeline,
                     const Core::Url &url, const UndeleteBlobOptions &options,
                     const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "undelete");
  request.SetHeader("x-ms-version", "2020-08-04");
  ...
  return Response<Models::UndeleteBlobResult>(std::move(response),
                                              std::move(pRawResponse));
}
Response<Models::SetBlobExpiryResult>
BlobClient::SetExpiry(Core::Http::_internal::HttpPipeline &pipeline,
                      const Core::Url &url, const SetBlobExpiryOptions &options,
                      const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  response.LastModified =
      DateTime::Parse(pRawResponse->GetHeaders().at("Last-Modified"),
                      Azure::DateTime::DateFormat::Rfc1123);
  return Response<Models::SetBlobExpiryResult>(std::move(response),
                                               std::move(pRawResponse));
}
Response<Models::SetBlobHttpHeadersResult> BlobClient::SetHttpHeaders(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const SetBlobHttpHeadersOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "properties");
  ...
  if (!Core::Convert::Base64Encode(options.BlobContentMD5).empty()) {
    request.SetHeader("x-ms-blob-content-md5",
                      Core::Convert::Base64Encode(options.BlobContentMD5));
  }
  if (!options.BlobContentEncoding.empty()) {
    request.SetHeader("x-ms-blob-content-encoding",
                      options.BlobContentEncoding);
  }
  if (!options.BlobContentLanguage.empty()) {
    request.SetHeader("x-ms-blob-content-language",
                      options.BlobContentLanguage);
  }
  if (options.LeaseId.HasValue() && !options.LeaseId.Value().empty()) {
    request.SetHeader("x-ms-lease-id", options.LeaseId.Value());
  }
  ...
  if (!options.BlobContentDisposition.empty()) {
    request.SetHeader("x-ms-blob-content-disposition",
  ...
  return Response<Models::SetBlobHttpHeadersResult>(std::move(response),
                                                    std::move(pRawResponse));
}
Response<Models::SetBlobImmutabilityPolicyResult>
BlobClient::SetImmutabilityPolicy(
  ...
  if (options.ImmutabilityPolicyExpiry.HasValue()) {
    request.SetHeader("x-ms-immutability-policy-until-date",
  ...
  if (options.ImmutabilityPolicyMode.HasValue() &&
    ...
    request.SetHeader("x-ms-immutability-policy-mode",
                      options.ImmutabilityPolicyMode.Value().ToString());
  }
  auto pRawResponse = pipeline.Send(request, context);
  auto httpStatusCode = pRawResponse->GetStatusCode();
  if (httpStatusCode != Core::Http::HttpStatusCode::Ok) {
...
Response<Models::DeleteBlobImmutabilityPolicyResult>
...
Response<Models::SetBlobLegalHoldResult> BlobClient::SetLegalHold(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const SetBlobLegalHoldOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  response.HasLegalHold =
      pRawResponse->GetHeaders().at("x-ms-legal-hold") == std::string("true");
  return Response<Models::SetBlobLegalHoldResult>(std::move(response),
                                                  std::move(pRawResponse));
}
Response<Models::SetBlobMetadataResult> BlobClient::SetMetadata(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const SetBlobMetadataOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "metadata");
  for (const auto &p : options.Metadata) {
    request.SetHeader("x-ms-meta-" + p.first, p.second);
  ...
  if (options.EncryptionScope.HasValue() &&
      !options.EncryptionScope.Value().empty()) {
  ...
  response.IsServerEncrypted =
      pRawResponse->GetHeaders().at("x-ms-request-server-encrypted") ==
      std::string("true");
  if (pRawResponse->GetHeaders().count("x-ms-encryption-key-sha256") != 0) {
    response.EncryptionKeySha256 = Core::Convert::Base64Decode(
        pRawResponse->GetHeaders().at("x-ms-encryption-key-sha256"));
  ...
  return Response<Models::SetBlobMetadataResult>(std::move(response),
                                                 std::move(pRawResponse));
}
Response<Models::_detail::AcquireBlobLeaseResult> BlobClient::AcquireLease(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const AcquireBlobLeaseOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "lease");
  request.SetHeader("x-ms-lease-action", "acquire");
  if (options.Duration.HasValue()) {
...
Response<Models::_detail::ReleaseBlobLeaseResult> BlobClient::ReleaseLease(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const ReleaseBlobLeaseOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "lease");
  request.SetHeader("x-ms-lease-action", "release");
  if (!options.LeaseId.empty()) {
...
Response<Models::_detail::RenewBlobLeaseResult> BlobClient::RenewLease(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const RenewBlobLeaseOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "lease");
  request.SetHeader("x-ms-lease-action", "renew");
  if (!options.LeaseId.empty()) {
...
Response<Models::_detail::ChangeBlobLeaseResult> BlobClient::ChangeLease(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const ChangeBlobLeaseOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "lease");
  request.SetHeader("x-ms-lease-action", "change");
  if (!options.LeaseId.empty()) {
...
Response<Models::_detail::BreakBlobLeaseResult> BlobClient::BreakLease(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const BreakBlobLeaseOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "lease");
  request.SetHeader("x-ms-lease-action", "break");
  if (options.BreakPeriod.HasValue()) {
...
Response<Models::CreateBlobSnapshotResult> BlobClient::CreateSnapshot(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const CreateBlobSnapshotOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  response.IsServerEncrypted =
      pRawResponse->GetHeaders().at("x-ms-request-server-encrypted") ==
      std::string("true");
  return Response<Models::CreateBlobSnapshotResult>(std::move(response),
                                                    std::move(pRawResponse));
}
Response<Models::_detail::StartBlobCopyFromUriResult>
BlobClient::StartCopyFromUri(Core::Http::_internal::HttpPipeline &pipeline,
                             const Core::Url &url,
  ...
  request.SetHeader("x-ms-version", "2020-08-04");
  if (options.BlobTagsString.HasValue() &&
      !options.BlobTagsString.Value().empty()) {
    request.SetHeader("x-ms-tags", options.BlobTagsString.Value());
  }
  if (options.SealBlob.HasValue()) {
    request.SetHeader("x-ms-seal-blob",
                      options.SealBlob.Value() ? "true" : "false");
  }
  if (options.ImmutabilityPolicyExpiry.HasValue()) {
    request.SetHeader("x-ms-immutability-policy-until-date",
                      options.ImmutabilityPolicyExpiry.Value().ToString(
  ...
  if (options.LegalHold.HasValue()) {
    request.SetHeader("x-ms-legal-hold",
                      options.LegalHold.Value() ? "true" : "false");
  }
  auto pRawResponse = pipeline.Send(request, context);
  auto httpStatusCode = pRawResponse->GetStatusCode();
  if (httpStatusCode != Core::Http::HttpStatusCode::Accepted) {
...
Response<Models::CopyBlobFromUriResult> BlobClient::CopyFromUri(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const CopyBlobFromUriOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  return Response<Models::CopyBlobFromUriResult>(std::move(response),
                                                 std::move(pRawResponse));
}
Response<Models::AbortBlobCopyFromUriResult> BlobClient::AbortCopyFromUri(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const AbortBlobCopyFromUriOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  return Response<Models::AbortBlobCopyFromUriResult>(std::move(response),
                                                      std::move(pRawResponse));
}
Response<Models::SetBlobAccessTierResult>
BlobClient::SetTier(Core::Http::_internal::HttpPipeline &pipeline,
                    const Core::Url &url, const SetBlobTierOptions &options,
                    const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  return Response<Models::SetBlobAccessTierResult>(std::move(response),
                                                   std::move(pRawResponse));
}
Response<std::map<std::string, std::string>>
BlobClient::GetTags(Core::Http::_internal::HttpPipeline &pipeline,
                    const Core::Url &url, const GetBlobTagsOptions &options,
                    const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Get, url);
  ...
  std::map<std::string, std::string> response;
  {
    ...
    const std::unordered_map<std::string, XmlTagEnum> XmlTagEnumMap{
        {"Tags", XmlTagEnum::kTags},   {"TagSet", XmlTagEnum::kTagSet},
        {"Tag", XmlTagEnum::kTag},     {"Key", XmlTagEnum::kKey},
        {"Value", XmlTagEnum::kValue},
    };
    std::vector<XmlTagEnum> xmlPath;
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 4 && xmlPath[0] == XmlTagEnum::kTags &&
            xmlPath[1] == XmlTagEnum::kTagSet &&
            xmlPath[2] == XmlTagEnum::kTag && xmlPath[3] == XmlTagEnum::kKey) {
          mapKey1 = node.Value;
        } else if (xmlPath.size() == 4 && xmlPath[0] == XmlTagEnum::kTags &&
                   xmlPath[1] == XmlTagEnum::kTagSet &&
                   xmlPath[2] == XmlTagEnum::kTag &&
  ...
  return Response<std::map<std::string, std::string>>(std::move(response),
                                                      std::move(pRawResponse));
}
Response<Models::SetBlobTagsResult>
BlobClient::SetTags(Core::Http::_internal::HttpPipeline &pipeline,
                    const Core::Url &url, const SetBlobTagsOptions &options,
                    const Core::Context &context) {
  std::string xmlBody;
  {
    _internal::XmlWriter writer;
    ...
    writer.Write(
        _internal::XmlNode{_internal::XmlNodeType::StartTag, "TagSet"});
    for (const auto &i1i2 : options.Tags) {
      ...
      writer.Write(
          _internal::XmlNode{_internal::XmlNodeType::StartTag, "Key", i1});
      writer.Write(
          _internal::XmlNode{_internal::XmlNodeType::StartTag, "Value", i2});
      writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
  ...
  if (options.TransactionalContentMD5.HasValue() &&
      !Core::Convert::Base64Encode(options.TransactionalContentMD5.Value())
           .empty()) {
    request.SetHeader(
        "Content-MD5",
        Core::Convert::Base64Encode(options.TransactionalContentMD5.Value()));
  ...
  return Response<Models::SetBlobTagsResult>(std::move(response),
                                             std::move(pRawResponse));
}
Response<Models::CreatePageBlobResult> PageBlobClient::Create(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const CreatePageBlobOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  request.SetHeader("x-ms-blob-content-length",
                    std::to_string(options.BlobContentLength));
  if (options.BlobSequenceNumber.HasValue()) {
    request.SetHeader("x-ms-blob-sequence-number",
                      std::to_string(options.BlobSequenceNumber.Value()));
  }
  request.SetHeader("x-ms-version", "2020-08-04");
  if (options.BlobTagsString.HasValue() &&
      !options.BlobTagsString.Value().empty()) {
  ...
  return Response<Models::CreatePageBlobResult>(std::move(response),
                                                std::move(pRawResponse));
}
Response<Models::UploadPagesResult> PageBlobClient::UploadPages(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    Core::IO::BodyStream &requestBody,
    const UploadPageBlobPagesOptions &options, const Core::Context &context) {
  auto request =
      Core::Http::Request(Core::Http::HttpMethod::Put, url, &requestBody);
  ...
  return Response<Models::UploadPagesResult>(std::move(response),
                                             std::move(pRawResponse));
}
Response<Models::ClearPagesResult> PageBlobClient::ClearPages(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const ClearPageBlobPagesOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "page");
  ...
  response.SequenceNumber =
      std::stoll(pRawResponse->GetHeaders().at("x-ms-blob-sequence-number"));
  return Response<Models::ClearPagesResult>(std::move(response),
                                            std::move(pRawResponse));
}
Response<Models::UploadPagesFromUriResult> PageBlobClient::UploadPagesFromUri(
  ...
  return Response<Models::UploadPagesFromUriResult>(std::move(response),
                                                    std::move(pRawResponse));
}
Response<Models::_detail::GetPageRangesResult> PageBlobClient::GetPageRanges(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const GetPageBlobPageRangesOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Get, url);
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 3 && xmlPath[0] == XmlTagEnum::kPageList &&
            ...
            xmlPath[2] == XmlTagEnum::kStart) {
          vectorElement1.Offset = std::stoll(node.Value);
        } else if (xmlPath.size() == 3 && xmlPath[0] == XmlTagEnum::kPageList &&
                   xmlPath[1] == XmlTagEnum::kPageRange &&
                   xmlPath[2] == XmlTagEnum::kEnd) {
        ...
        if (xmlPath.size() == 2 && xmlPath[0] == XmlTagEnum::kPageList &&
            xmlPath[1] == XmlTagEnum::kPageRange) {
          vectorElement1.Length =
              vectorElement1.Length.Value() - vectorElement1.Offset + 1;
          response.PageRanges.push_back(std::move(vectorElement1));
          vectorElement1 = Core::Http::HttpRange();
        } else if (xmlPath.size() == 2 && xmlPath[0] == XmlTagEnum::kPageList &&
                   xmlPath[1] == XmlTagEnum::kClearRange) {
          vectorElement2.Length =
              vectorElement2.Length.Value() - vectorElement2.Offset + 1;
...
Response<Models::_detail::GetPageRangesDiffResult>
PageBlobClient::GetPageRangesDiff(
  ...
  if (options.Prevsnapshot.HasValue() &&
      !options.Prevsnapshot.Value().empty()) {
    request.GetUrl().AppendQueryParameter(
        "prevsnapshot",
        _internal::UrlEncodeQueryParameter(options.Prevsnapshot.Value()));
  }
  if (options.PrevSnapshotUrl.HasValue() &&
      !options.PrevSnapshotUrl.Value().empty()) {
    request.SetHeader("x-ms-previous-snapshot-url",
                      options.PrevSnapshotUrl.Value());
  }
  if (options.Range.HasValue() && !options.Range.Value().empty()) {
    request.SetHeader("x-ms-range", options.Range.Value());
  }
...
Response<Models::ResizePageBlobResult> PageBlobClient::Resize(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const ResizePageBlobOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  request.GetUrl().AppendQueryParameter("comp", "properties");
  if (options.LeaseId.HasValue() && !options.LeaseId.Value().empty()) {
    request.SetHeader("x-ms-lease-id", options.LeaseId.Value());
  ...
  response.SequenceNumber =
      std::stoll(pRawResponse->GetHeaders().at("x-ms-blob-sequence-number"));
  return Response<Models::ResizePageBlobResult>(std::move(response),
                                                std::move(pRawResponse));
}
Response<Models::UpdateSequenceNumberResult>
PageBlobClient::UpdateSequenceNumber(
  ...
  if (!options.SequenceNumberAction.ToString().empty()) {
    request.SetHeader("x-ms-sequence-number-action",
                      options.SequenceNumberAction.ToString());
  }
  if (options.BlobSequenceNumber.HasValue()) {
    request.SetHeader("x-ms-blob-sequence-number",
                      std::to_string(options.BlobSequenceNumber.Value()));
  ...
  response.SequenceNumber =
      std::stoll(pRawResponse->GetHeaders().at("x-ms-blob-sequence-number"));
  return Response<Models::UpdateSequenceNumberResult>(std::move(response),
                                                      std::move(pRawResponse));
}
Response<Models::_detail::StartBlobCopyIncrementalResult>
...
Response<Models::CreateAppendBlobResult> AppendBlobClient::Create(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const CreateAppendBlobOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  return Response<Models::CreateAppendBlobResult>(std::move(response),
                                                  std::move(pRawResponse));
}
Response<Models::AppendBlockResult> AppendBlobClient::AppendBlock(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    Core::IO::BodyStream &requestBody,
    const AppendAppendBlobBlockOptions &options, const Core::Context &context) {
  auto request =
      Core::Http::Request(Core::Http::HttpMethod::Put, url, &requestBody);
  ...
  if (options.MaxSize.HasValue()) {
    request.SetHeader("x-ms-blob-condition-maxsize",
                      std::to_string(options.MaxSize.Value()));
  }
  if (options.AppendPosition.HasValue()) {
    request.SetHeader("x-ms-blob-condition-appendpos",
                      std::to_string(options.AppendPosition.Value()));
  }
  if (options.EncryptionKey.HasValue() &&
      !options.EncryptionKey.Value().empty()) {
    request.SetHeader("x-ms-encryption-key", options.EncryptionKey.Value());
  ...
  response.AppendOffset =
      std::stoll(pRawResponse->GetHeaders().at("x-ms-blob-append-offset"));
  response.CommittedBlockCount = std::stoi(
      pRawResponse->GetHeaders().at("x-ms-blob-committed-block-count"));
  response.IsServerEncrypted =
      pRawResponse->GetHeaders().at("x-ms-request-server-encrypted") ==
  ...
  return Response<Models::AppendBlockResult>(std::move(response),
                                             std::move(pRawResponse));
}
Response<Models::AppendBlockFromUriResult> AppendBlobClient::AppendBlockFromUri(
  ...
  response.IsServerEncrypted =
      pRawResponse->GetHeaders().at("x-ms-request-server-encrypted") ==
      std::string("true");
  return Response<Models::AppendBlockFromUriResult>(std::move(response),
                                                    std::move(pRawResponse));
}
Response<Models::SealAppendBlobResult> AppendBlobClient::Seal(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const SealAppendBlobOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Put, url);
  ...
  return Response<Models::SealAppendBlobResult>(std::move(response),
                                                std::move(pRawResponse));
}
Response<Models::UploadBlockBlobResult>
BlockBlobClient::Upload(Core::Http::_internal::HttpPipeline &pipeline,
                        const Core::Url &url, Core::IO::BodyStream &requestBody,
  ...
  return Response<Models::UploadBlockBlobResult>(std::move(response),
                                                 std::move(pRawResponse));
}
Response<Models::UploadBlockBlobFromUriResult>
BlockBlobClient::UploadFromUri(Core::Http::_internal::HttpPipeline &pipeline,
                               const Core::Url &url,
  ...
  if (options.CopySourceBlobProperties.HasValue()) {
    request.SetHeader("x-ms-copy-source-blob-properties",
                      options.CopySourceBlobProperties.Value() ? "true"
                                                               : "false");
  }
  if (options.SourceContentcrc64.HasValue() &&
      !Core::Convert::Base64Encode(options.SourceContentcrc64.Value())
...
Response<Models::StageBlockResult> BlockBlobClient::StageBlock(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    Core::IO::BodyStream &requestBody,
    const StageBlockBlobBlockOptions &options, const Core::Context &context) {
  auto request =
      Core::Http::Request(Core::Http::HttpMethod::Put, url, &requestBody);
  ...
  return Response<Models::StageBlockResult>(std::move(response),
                                            std::move(pRawResponse));
}
Response<Models::StageBlockFromUriResult> BlockBlobClient::StageBlockFromUri(
  ...
  return Response<Models::StageBlockFromUriResult>(std::move(response),
                                                   std::move(pRawResponse));
}
Response<Models::CommitBlockListResult>
BlockBlobClient::CommitBlockList(Core::Http::_internal::HttpPipeline &pipeline,
                                 const Core::Url &url,
  ...
  std::string xmlBody;
  {
    _internal::XmlWriter writer;
    writer.Write(
        _internal::XmlNode{_internal::XmlNodeType::StartTag, "BlockList"});
    ...
    for (const auto &i3 : options.Blocks.Latest) {
      writer.Write(
          _internal::XmlNode{_internal::XmlNodeType::StartTag, "Latest", i3});
    }
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::EndTag});
    writer.Write(_internal::XmlNode{_internal::XmlNodeType::End});
    xmlBody = writer.GetDocument();
  ...
  return Response<Models::CommitBlockListResult>(std::move(response),
                                                 std::move(pRawResponse));
}
Response<Models::GetBlockListResult> BlockBlobClient::GetBlockList(
    Core::Http::_internal::HttpPipeline &pipeline, const Core::Url &url,
    const GetBlockBlobBlockListOptions &options, const Core::Context &context) {
  auto request = Core::Http::Request(Core::Http::HttpMethod::Get, url);
  request.GetUrl().AppendQueryParameter("comp", "blocklist");
  if (options.Snapshot.HasValue() && !options.Snapshot.Value().empty()) {
    request.GetUrl().AppendQueryParameter(
  ...
  if (!options.ListType.ToString().empty()) {
    request.GetUrl().AppendQueryParameter(
        "blocklisttype",
        _internal::UrlEncodeQueryParameter(options.ListType.ToString()));
  }
  if (options.LeaseId.HasValue() && !options.LeaseId.Value().empty()) {
    request.SetHeader("x-ms-lease-id", options.LeaseId.Value());
  }
    ...
    while (true) {
      ...
      if (node.Type == _internal::XmlNodeType::End) {
        ...
        if (xmlPath.size() == 4 && xmlPath[0] == XmlTagEnum::kBlockList &&
            xmlPath[1] == XmlTagEnum::kCommittedBlocks &&
            xmlPath[2] == XmlTagEnum::kBlock &&
            xmlPath[3] == XmlTagEnum::kName) {
          vectorElement1.Name = node.Value;
        } else if (xmlPath.size() == 4 &&
                   xmlPath[0] == XmlTagEnum::kBlockList &&
                   xmlPath[1] == XmlTagEnum::kCommittedBlocks &&
                   xmlPath[2] == XmlTagEnum::kBlock &&
          ...
          vectorElement1.Size = std::stoll(node.Value);
                   ...
                   xmlPath[0] == XmlTagEnum::kBlockList &&
                   xmlPath[1] == XmlTagEnum::kUncommittedBlocks &&
                   xmlPath[2] == XmlTagEnum::kBlock &&
                   xmlPath[3] == XmlTagEnum::kName) {
  ...
  return Response<Models::GetBlockListResult>(std::move(response),
                                              std::move(pRawResponse));
}
} // namespace _detail
} // namespace Blobs
