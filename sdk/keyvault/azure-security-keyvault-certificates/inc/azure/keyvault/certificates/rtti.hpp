 ...
 * `AZURE_SECURITY_KEYVAULT_CERTIFICATES_RTTI`. When the macro is not defined, RTTI is disabled.
 *
...
/**
 * @def AZURE_SECURITY_KEYVAULT_CERTIFICATES_RTTI
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_SECURITY_KEYVAULT_CERTIFICATES_RTTI@*/)
#define AZURE_SECURITY_KEYVAULT_CERTIFICATES_RTTI
#endif
