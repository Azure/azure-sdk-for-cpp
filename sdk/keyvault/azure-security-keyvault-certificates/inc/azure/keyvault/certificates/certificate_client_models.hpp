...
namespace Azure { namespace Security { namespace KeyVault { namespace Certificates {
  ...
  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::PurgeDeletedCertificate .
   *
   */
  struct PurgeDeletedCertificateOptions final
  {
  };

  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::StartRecoverDeletedCertificate .
   *
   */
  struct StartRecoverDeletedCertificateOptions final
  {
  };

  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::GetCertificatePolicy .
   *
   */
  struct GetCertificatePolicyOptions final
  {
  };

  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::UpdateCertificatePolicy .
   *
   */
  struct UpdateCertificatePolicyOptions final
  {
  };

  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::RestoreCertificateBackup .
   *
   */
  struct RestoreCertificateBackupOptions final
  {
  };

  /**
   * @brief Additional parameters for method Azure::Security::KeyVault::Certificates::DeleteIssuer .
   *
   */
  struct DeleteIssuerOptions final
  {
  };

  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::BackupCertificate .
   *
   */
  struct BackupCertificateOptions final
  {
  };

  /**
   * @brief Additional parameters for method Azure::Security::KeyVault::Certificates::GetContacts .
   *
   */
  struct GetContactsOptions final
  {
  };

  /**
   * @brief Additional parameters for method Azure::Security::KeyVault::Certificates::DeleteContacts
   * .
   *
   */
  struct DeleteContactsOptions final
  {
  };

  /**
   * @brief Additional parameters for method Azure::Security::KeyVault::Certificates::SetContacts .
   *
   */
  struct SetContactsOptions final
  {
  };

  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::GetDeletedCertificate .
   *
   */
  struct GetDeletedCertificateOptions final
  {
  };

  /**
   * @brief Additional parameters for method Azure::Security::KeyVault::Certificates::GetCertificate
   * .
   *
   */
  ...
  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::CreateCertificate .
   *
   */
  struct CreateCertificateOptions final
  {
  };

  /**
   * @brief Additional parameters for method
   * Azure::Security::KeyVault::Certificates::StartDeleteCertificate .
   *
   */
  struct StartDeleteCertificateOptions final
  {
  };

  /**
   * @brief Additional parameters for method Azure::Security::KeyVault::Certificates::CreateIssuer .
   *
   */
  struct CreateIssuerOptions final
  {
  };

  /**
   * @brief Additional parameters for method Azure::Security::KeyVault::Certificates::GetIssuer .
   *
   */
  struct GetIssuerOptions final
  {
  };

  /**
   * @brief Additional parameters for method Azure::Security::KeyVault::Certificates::UpdateIssuer .
   *
   */
  struct UpdateIssuerOptions final
  {
  };
