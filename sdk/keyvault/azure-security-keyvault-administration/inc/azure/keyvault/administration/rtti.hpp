 ...
 * `AZURE_SECURITY_KEYVAULT_ADMINISTRATION_RTTI`. When the macro is not defined, RTTI is disabled.
 *
...
/**
 * @def AZURE_SECURITY_KEYVAULT_ADMINISTRATION_RTTI
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_SECURITY_KEYVAULT_ADMINISTRATION_RTTI@*/)
#define AZURE_SECURITY_KEYVAULT_ADMINISTRATION_RTTI
#endif
