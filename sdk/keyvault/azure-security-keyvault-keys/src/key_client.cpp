...
Azure::Response<Azure::Security::KeyVault::Keys::BackupKey> KeyClient::BackupKey(
    std::string const& name,
    Azure::Core::Context const& context) const
{
  ...
  return Azure::Response<Azure::Security::KeyVault::Keys::BackupKey>(
      Azure::Security::KeyVault::Keys::BackupKey(response.Value.Value),
      std::move(response.RawResponse));
}
