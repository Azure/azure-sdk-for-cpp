  ...
  namespace _detail {
    ...
    private:
      ...
      public:
        ...
        /**
         * @brief Start the receive queue. This will start a thread that will process incoming
         * frames.
         *
      ...
      private:
         ...
         *
         * @returns True if the ping was sent, false if the underlying transport didn't support
         * "Ping" operations.
         */
      ...
      std::vector<uint8_t> ReadTransportBytes(
          size_t readLength,
          Azure::Core::Context const& context);
      ...
      std::shared_ptr<Azure::Core::Http::_detail::WebSockets::WebSocketTransport> m_transport;
...
}}}}}} // namespace Azure::Core::Http::_detail::WebSockets::_detail
