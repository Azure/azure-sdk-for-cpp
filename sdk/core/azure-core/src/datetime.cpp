...
constexpr ComputeYearResult ComputeYear(int64_t secondsSince1601)
{
  ...
  constexpr int YearsFrom1601To1700 = 1700 - 1601;
  constexpr int64_t SecondsFrom1601To1700
      = ((YearsFrom1601To1700 / 4) * DaysIn4Years + (YearsFrom1601To1700 % 4) * DaysInYear)
  ...
  if (secondsSince1601 > SecondsFrom1601To1700)
  {
    secondsLeft -= SecondsFrom1601To1700;
    year4 += 99 / 4;
    year1 += 99 % 4;
    ...
    year400 = static_cast<int>(secondsLeft / SecondsIn400Years);
    secondsLeft -= year400 * SecondsIn400Years;

    year100 = static_cast<int>(secondsLeft / SecondsIn100Years);
