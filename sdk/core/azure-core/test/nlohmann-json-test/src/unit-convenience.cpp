...
TEST_CASE("convenience functions")
{
    ...
    SECTION("string concat")
    {
        ...
        {
          alt_string_iter str = Azure::Core::Json::_internal::detail::concat<alt_string_iter>(
              hello_iter, world, '!');
        ...
        {
          alt_string_data str = Azure::Core::Json::_internal::detail::concat<alt_string_data>(
              hello_data, world, '!');
