...
TEST_CASE("bad_alloc")
{
    SECTION("bad_alloc")
    {
        ...
        using bad_json = Azure::Core::Json::_internal::json::basic_json<std::map,
              std::vector,
              std::string,
              bool,
              std::int64_t,
...
{
    // create JSON type using the throwing allocator
    using my_json = Azure::Core::Json::_internal::json::basic_json<std::map,
          std::vector,
          std::string,
          bool,
          std::int64_t,
...
TEST_CASE("bad my_allocator::construct")
{
    ...
    {
        using bad_alloc_json = Azure::Core::Json::_internal::json::basic_json<std::map,
              std::vector,
              std::string,
              bool,
              std::int64_t,
