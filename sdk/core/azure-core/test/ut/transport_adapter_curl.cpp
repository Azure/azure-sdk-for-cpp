...
namespace Azure { namespace Core { namespace Test {
  ...
  // commenting test since it can't be disabled as it depends on a friend declaration to access
  // private fields
  ...
  //       // connections in the pool. If first request is too fast, the second request will reuse
  //       the
  //       // same connection.
  //       EXPECT_PRED1(
