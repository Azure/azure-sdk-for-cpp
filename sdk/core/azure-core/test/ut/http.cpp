...
namespace Azure { namespace Core { namespace Test {
  ...
  TEST(TestHttp, RequestStartTry)
  {
...

    {
      ...
      EXPECT_EQ(
          Azure::IO::BodyStream::ReadToCount(stream, temp.data(), 1, Context::GetApplicationContext()), 1);
      ...
      EXPECT_EQ(
          Azure::IO::BodyStream::ReadToCount(*getStream, temp.data(), 2, Context::GetApplicationContext()),
          2);
