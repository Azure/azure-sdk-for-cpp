 ...
 *
 * @details When RTTI is enabled, defines a macro `AZURE_CORE_RTTI`. When
...
/**
 * @def AZURE_CORE_TRACING_OPENTELEMETRY_RTTI
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_CORE_TRACING_OPENTELEMETRY_RTTI@*/)
#define AZURE_CORE_TRACING_OPENTELEMETRY_RTTI
#endif
