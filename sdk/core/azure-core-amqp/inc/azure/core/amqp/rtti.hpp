 ...
 *
 * @details When RTTI is enabled, defines a macro `AZURE_CORE_AMQP_RTTI`. When
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_CORE_RTTI@*/)
#define AZURE_CORE_AMQP_RTTI
#endif
