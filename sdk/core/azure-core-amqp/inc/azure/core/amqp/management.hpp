...
namespace Azure { namespace Core { namespace Amqp {
  ...
  namespace _internal {
    enum class ManagementOperationResult
    {
      Invalid,
      Ok,
      Error,
    ...
    enum class ManagementOpenResult
    {
      Invalid,
      Ok,
      Error,
    ...
    public:
       ...
       */
      ManagementOpenResult Open(Azure::Core::Context const& context = {});
       ...
       *
       * @returns a tuple consisting of the high level result of the operation, the HTTP response
       * status code, the status description, and the response message.
       */
      std::tuple<
