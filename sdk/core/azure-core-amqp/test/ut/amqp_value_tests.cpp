...
TEST_F(TestValues, DecimalTypesRequireExactWidth)
{
  EXPECT_THROW((AmqpDecimal32{0x01, 0x02, 0x03}), std::invalid_argument);
  EXPECT_THROW((AmqpDecimal64{0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07}), std::invalid_argument);
  EXPECT_THROW(
      (AmqpDecimal128{
          0x01,
          0x02,
