...
namespace Azure { namespace Core { namespace Amqp { namespace Models {
    ...
    AmqpArray::operator AmqpValue() const
    {
    ...
    AmqpMap::operator const AmqpValue() const
    {
      return static_cast<UniqueAmqpValueHandle>(*this).get();
    }
    ...
    {
      UniqueAmqpValueHandle symbol{amqpvalue_create_timestamp(count())};
      return symbol.release();
    }
