...
namespace Azure { namespace Core { namespace Amqp { namespace _detail {
    ...
    MessageSenderImpl::MessageSenderImpl(
        ...
        _internal::MessageSenderOptions const& options,
        _internal::MessageSenderEvents* events)
        : m_listener{true}, m_events{events}, m_session{session}, m_target{target},
          m_options{options}
    {
      CreateLink(endpoint);
    ...
    {
      return m_link->GetMaxMessageSize();
    }
        ...
        Context const& context)
    {
      ...
      QueueSendInternal(
          ...
          context);
      std::unique_ptr<std::tuple<_internal::MessageSendStatus, Models::_internal::AmqpError>>
          result;
