...
TEST(ChallengeClientSecretCredential, RegularADFS)
{
  auto const actual = CredentialTestHelper::SimulateTokenRequest(
      [](auto transport) {
        ClientSecretCredentialOptions options;
...
TEST(ChallengeClientSecretCredential, AuthorityADFS)
{
  auto const actual1 = CredentialTestHelper::SimulateTokenRequest(
      [](auto transport) {
        ClientSecretCredentialOptions options;
        ...
        return std::make_unique<ChallengeClientSecretCredential>(
            "adfs", "fedcba98-7654-3210-0123-456789abcdef", "CLIENTSECRET1", options);
      },
      {{{"https://azure.com/.default"}}},
      {"{\"expires_in\":3600, \"access_token\":\"ACCESSTOKEN1\"}"});
...
TEST(ChallengeClientSecretCredential, ADFS)
{
  EXPECT_NO_THROW(
      auto credential
      = std::make_shared<Azure::Identity::ChallengeClientSecretCredential>("adfs", "cid", "cs"));
}