 ...
 *
 * @details When RTTI is enabled, defines a macro `AZURE_IDENTITY_RTTI`. When
...
#if defined(AZURE_RTTI) || (0 /*@AZURE_IDENTITY_RTTI@*/)
#define AZURE_IDENTITY_RTTI
#endif
