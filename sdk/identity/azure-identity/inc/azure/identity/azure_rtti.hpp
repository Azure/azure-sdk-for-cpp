 ...
 *
 * @details Checks whenever RTTI is enabled and exports the symbol `AZ_IDENTITY_WITH_RTTI`. When
 ...
 * header requires to resolve `AZ_IDENTITY_WITH_RTTI` which will become ` + 1 ` when the SDK was
 * built with RTTI and `false` otherwise.
 */

#if AZ_BUILD_RTTI || (0 /*@AZ_IDENTITY_WITH_RTTI@*/)
#define AZ_IDENTITY_WITH_RTTI 1
#endif
