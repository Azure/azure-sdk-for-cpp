...
- `ClientSecretCredential ` constructor takes `TokenCredentialOptions` struct instead of authority host string. `TokenCredentialOptions` struct has authority host string as data member.
