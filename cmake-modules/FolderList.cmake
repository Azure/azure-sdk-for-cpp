macro(GetFolderList project)
    ...
    elseif(${project} STREQUAL STORAGE_COMMON)
        DownloadDepVersion(sdk/core azure-core 1.16.3)
    elseif(${project} STREQUAL STORAGE_BLOBS)
        DownloadDepVersion(sdk/core azure-core 1.16.3)
        DownloadDepVersion(sdk/storage/azure-storage-common azure-storage-common 12.14.0)
    elseif(${project} STREQUAL STORAGE_FILES_DATALAKE)
        DownloadDepVersion(sdk/core azure-core 1.16.3)
        DownloadDepVersion(sdk/storage/azure-storage-common azure-storage-common 12.14.0)
        DownloadDepVersion(sdk/storage/azure-storage-blobs azure-storage-blobs 12.18.0)
