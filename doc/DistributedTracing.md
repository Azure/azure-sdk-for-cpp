...
# _Distributed Tracing in the C++ SDK
...
## _Distributed Tracing Client Integration
...
### _Integrate an OpenTelemetryProvider via the ApplicationContext
...
### _Integrate an OpenTelemetryProvider via Service ClientOptions
...
## _Distributed Tracing Service Integration
...
### _Add a `DiagnosticTracingFactory` to the serviceClient class
...
### _Distributed Tracing components
