...
The Azure standards for distributed tracing are defined in the [Azure SDK Design Guidelines: Distributed Tracing](https://azure.github.io/azure-sdk/general_implementation.html#distributed-tracing).
The semantic attributes generated by Azure services align with the [OpenTelemetry Semantic Conventions](https://github.com/open-telemetry/semantic-conventions).
