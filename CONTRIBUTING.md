...
Keep in mind that enabling static analysis will impact building time significantly, so it is recommended to run it right before submitting the PR but not in your inner developer loop.
