...
The static code analysis is `ON` for the CI pipelines. You can usually turn this feature `ON` locally to debug errors reported during CI or for the last time you build and test before creating a new PR.
